...
//    }
     ...
     * @return
     */
    public static String getPartImg(String partimg) {

        if (TextUtils.isEmpty(partimg)) {
            return "";
        } else {
            String[] split = partimg.split(",");
            if (split.length >= 1) {
                return split[0];
            } else {
                return "";
     ...
     * @return
     */
    public static List<String> getPartImgList(String partimg) {
        if (TextUtils.isEmpty(partimg)) {
