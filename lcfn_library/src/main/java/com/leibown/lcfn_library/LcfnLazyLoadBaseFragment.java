...
//        unbinder = ButterKnife.bind(this, getContentView());
    ...
    public static <T extends LcfnLazyLoadBaseFragment> T newInstans(Class clz) {
        return newInstans(null, clz);
    }


    public static <T extends LcfnLazyLoadBaseFragment> T newInstans(Bundle bundle, Class clz) {
        LcfnLazyLoadBaseFragment baseFragment = null;
        try {
            Object instance = clz.newInstance();
            if (instance instanceof LcfnLazyLoadBaseFragment) {
                baseFragment = (LcfnLazyLoadBaseFragment) instance;
